...
Download the latest lab documentation and lab manual from `Release v-report-docs <https://github.com/Hzaatiti/meg-pipeline/releases>`_

- `MEG Lab documentation PDF download <https://github.com/Hzaatiti/meg-pipeline/releases/meg-lab-documentation.pdf>`_
- `MEG Lab manual PDF download <https://github.com/Hzaatiti/meg-pipeline/releases/meg-lab-manual.pdf>`_
