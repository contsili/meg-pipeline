...
%%% need to check responses being saved; %%%
%%% need to save this and save responses; %%%
%%% need to add condition or create a different script that changes timings
%%% based on session number? %%%
%%% what happens when it appears on the wrong side and they CORRECTLY don't
%%% respond? %%%
%%% why am i getting nans/responses aren't being saved?%%%
%%% is it missing or incorrect when it's on the attended side and we don't
%%% click?
