...
.. dropdown:: Two demonstrations: Resting state and Attention (contra-lateral) `50min`
    ...
    - Experiment 1: Resting state: `25min` `Access link to code and description <resting_state_exp>`_
        - Two blocks: a block of 10min eyes open and a second block of 10min eyes closed
    - Experiment 2: Attention with different field of view points `25min` `Access link to code and description <attention_exp>`_
