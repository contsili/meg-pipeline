...
.. dropdown:: Two demonstrations: Resting state :ref:`resting_state_exp` and attention (contra-lateral) :ref:`attention_exp` `50min`
    ...
    - Experiment 2: Attention with different field of view points `25min` :ref:`attention_exp` `50min`
...
.. dropdown:: Show and discuss analysis results `15min`
    ...
    - Experiment 1: Resting state `Analysis Notebook <../../5-pipeline/notebooks/resting_state_pipeline.ipynb>`_
